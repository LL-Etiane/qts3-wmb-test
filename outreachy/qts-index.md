...
- **Last Batches**: This link is just a hashtag link and does not take you anywhere yet. It may still be a work in progress to implement it functonality.
- **Git**: Links to the Git repository of the main codebase for quickstatements V3.
- **Login**: This link is also a hashtag link and functionality still to be implemented.
...
- **Batch Search Form**: 
   ...
   - Both "Search" buttons currently do not have functionality linked to them yet. still a functionality to be implemented.
